...
-- Código --
select  DISTINCT lnbts.plmn_id, lnbts.mrbts_id, lnbts.lnBTS_id, case when lnbts.name is null then lnbts.enbName else lnbts.name end as eNB_Name, lncel.name as LNCELL_Name, 
